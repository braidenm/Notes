...
CREATE INDEX `fk_note_to_user_idx` ON `note` (`user_id` ASC);
...
START TRANSACTION;
USE `Notes`;
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `password`, `enabled`, `email`, `role`) VALUES (1, 'admin', 'admin', 'admin', 'password', 1, 'admin@admin.com', 'admin');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `password`, `enabled`, `email`, `role`) VALUES (2, 'basic', 'user', 'user', 'password', 1, 'user@user.com', 'standard');
